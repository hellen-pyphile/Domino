//DOM_HJRV_Model - Projeto Domin√≥ LP2026
//02/09/2026
//Hellen Araujo da Silva, Jo√£o Vitor Carvalho Magalhaes Quintella, Rodrigo Corio Ferrer dos Santos, Victoria Spina Tavares
//Req09
...
{
	int qtdMesaJogo; //qtd.de peÁas na mesa
	int turnoJogo; //jogador atual
	int jogadorComp; //2 = o computador n„o È o jogador 2
	Peca mesaJogo[28];
	int mesaDJogo;
	int mesaEJogo;
